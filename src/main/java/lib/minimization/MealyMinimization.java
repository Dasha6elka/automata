...
public class MealyMinimization {
    ...
    private void fillSources(List<MealyEdgeEq> converted,
    ...
    private List<MealyNode> getSortedNodes(List<MealyEdgeEq> converted) {
        var sortMooreEdges = getSortEdges(converted);
